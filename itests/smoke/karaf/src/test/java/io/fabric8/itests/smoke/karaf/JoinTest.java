...
public class JoinTest {
	...
	public void testJoin() throws Exception {
        ...
        try {
            ...
            System.err.println(CommandSupport.executeCommand("admin:create -o '-server -Xmx768M -Dcom.sun.management.jmxremote -XX:+UnlockDiagnosticVMOptions -XX:+UnsyncloadClass -Dpatching.disabled=true -Djava.security.egd=file:/dev/./urandom' --featureURL mvn:io.fabric8/fabric8-karaf/" + version + "/xml/features --feature fabric-git --feature fabric-agent --feature fabric-boot-commands smoke_child_d"));
